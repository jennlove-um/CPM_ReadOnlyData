...
'course')),
     target_site_id
       AS (
          ...
          WHERE excluded_site_id.site_id is null)           select CURRENT_TIMESTAMP AS ACTION_TIME, SITE_ID AS SITE_ID, 'ACTION_LOG_LIST' AS ACTION_TAKEN from dual,target_site_id );
